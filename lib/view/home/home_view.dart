                          ...
                          child:Card(
                              child: Row(
                                children: [
                                  SizedBox(width: 20),
                                  Center(
                            child: Text(box_name.toString() +"   : اهلا و سهلا  ",
                            style:TextStyle(
                                  color: Colors.black,
                                  fontSize:18,
